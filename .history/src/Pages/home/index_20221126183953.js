      ...
      <Fragment>
        ...
        <HomeWrapper>
          ...
          <MainInfoSection>
            ...
            <MainInfoItemWrap>
              <Button id="apple" loading={500} onClick={this.searchphone}>
                Apple
              </Button>
              <Button id="asus" loading={500} onClick={this.searchphone}>
                Asus
              </Button>
              <Button id="samsung" loading={500} onClick={this.searchphone}>
                Samsung
              </Button>
              <Button id="mi" loading={500} onClick={this.searchphone}>
                小米
              </Button>
              <Button id="google" loading={500} onClick={this.searchphone}>
                Google
              </Button>
              <Button id="oppo" loading={500} onClick={this.searchphone}>
                OPPO
              </Button>
              <Button id="vivo" loading={500} onClick={this.searchphone}>
                VIVO
              </Button>
              <Button id="lg" onClick={this.searchphone}>
                LG
              </Button>
              <Button id="sony" onClick={this.searchphone}>
                SONY
              </Button>
            </MainInfoItemWrap>
          </MainInfoSection>
