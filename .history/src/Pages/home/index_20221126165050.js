      ...
      <Fragment>
        ...
        <HomeWrapper>
          ...
          <MainInfoSection>
            ...
            <MainInfoItemWrap>
              <Button id="apple" loading={1000} onClick={this.searchphone}>
                Apple
              </Button>
              <Button id="asus" onClick={this.searchphone}>
                Asus
              </Button>
              <Button id="samsung" onClick={this.searchphone}>
                Samsung
              </Button>
              <Button id="mi" onClick={this.searchphone}>
                小米
              </Button>
              <Button id="google" onClick={this.searchphone}>
                Google
              </Button>
              <Button id="oppo" onClick={this.searchphone}>
                OPPO
              </Button>
              <Button id="vivo" onClick={this.searchphone}>
                VIVO
              </Button>
